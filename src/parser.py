...
class Parser(object):  #
    def __init__(self):
        ...
        parser.add_argument("--propModel", default='propagation_krylov1', help='propagation model names',
        ...
        # Dataset Details
        parser.add_argument("--dataset", default='cora_multi', help="Dataset to evluate | Check Datasets folder",
